...
(function (window, $, undefined) {
    ...
    main.run(['mapDBC', 'wdtLoader', 'wmoLoader', 'wmoGroupLoader', 'mdxLoader', 'skinLoader', 'blpLoader', '$log', 'registerWMOImporter', 'registerFirstPersonCamera',
        function( mapDBC, wdtLoader, wmoLoader, wmoGroupLoader, mdxLoader, skinLoader, blpLoader, $log, registerWMOImporter, registerFirstPersonCamera ) {
            mapDBC();
